...
public class MybatisPlusGenerator {
    // 生成的文件项目路径
    private static String baseProjectPath = "E:\\Study\\wpc\\wpc\\";

    // 基本包名
    private static String basePackage = "net.froeasy";

    // 模块名
    private static String moduleName = "wpc";
    // 作者
    private static String authorName = "xmc";

    // 要生成的表名
    private static String[] tables = {"t_sys_menu"};

    // table的前缀
    private static String prefix = "t_sys_";
